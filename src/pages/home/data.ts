export type Widget = {
  type: "lineChart" | "barChart" | "progressChart" | "multiProgress" | "tableWidget"
  title: string;
  className: string;
  attributes: {
    serial?: string;
...
export const homePageWidgets: Widget[] = [
  {
    ...
    className: "col-span-full row-span-3 flex flex-col p-6 lg:col-span-6 2xl:col-span-5",
    attributes: {
      telemetries: [
        {
          area: false,
  ...
  },
  {
    ...
    className: "col-span-full row-span-6 flex flex-col gap-3 p-4 2xl:col-span-3",
    attributes: {
      telemetries: [
        {

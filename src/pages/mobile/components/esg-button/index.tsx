  ...
  return (
    <Dialog>
      ...
      >
        ...
        >
          <div className="relative mb-2 ml-3 mr-1 mt-6 flex h-1 flex-1 items-center justify-center sm:mb-2 sm:ml-4 sm:mr-4 sm:mt-6 md:ml-6 md:mr-6 lg:mb-8 lg:ml-16 lg:mr-8 2xl:mt-20">
            {activeSubTab > 0 && (
              <Button
                variant={"ghost"}
